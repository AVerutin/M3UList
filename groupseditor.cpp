...
/// Определить класс Group, содержащий наименование и Id группы
/// Получать список групп из БД
/// Сохранять и редактировать список групп в БД
/// После каждой операции, работающей со списком групп, синхронизировать его с БД
